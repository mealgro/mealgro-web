    ...
    <div class="min-h-screen help-page">
      <div class="help-container">
        <div class="help-content">
          <h1 class="help-title">{{ pageTitle || 'Terms of Service' }}</h1>
...
const fetchTermsAndConditions = async () => {
  try {
    ...
    const response = await axios.get('https://api.mealgro.com/v1/terms-and-conditions');
    
    if (response.data.status === 'success' && response.data.data) {
      pageTitle.value = response.data.data.title || 'Terms of Service';
