			...
			<div class="help-container">
				<div class="help-content">
					...
					<div v-else-if="error" class="help-section">
						<div class="help-text-content">
							<p>
								Error loading terms and conditions. Please try
								again later.
							</p>
						</div>
					</div>
					...
					<div v-else class="help-section">
						<div
							class="help-text-content markdown-content"
...
const fetchTermsAndConditions = async () => {
	try {
		...
		const result = await fetch(
			"https://api.mealgro.com/v1/terms-and-conditions",
		);
		...
		if (response.status === "success" && response.data) {
			pageTitle.value = response.data.title || "Terms of Service";
			...
			renderedContent.value = await marked.parse(markdownContent);
		} else {
			error.value = true;
		}
	} catch (err) {
