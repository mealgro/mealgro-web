	...
	<section class="vendors-hero">
		<div class="vendors-hero__container">
			...
			<div class="vendors-hero__left">
				<!-- Headline Text -->
				<h1 class="vendors-hero__headline pt-8">
					Easy to use food<br />
					service app for<br />
					vendors
				</h1>
				...
				<div class="vendors-hero__cta vendors-hero__cta--desktop">
					...
					<span class="vendors-hero__button-text">
						...
						<img
							:src="appStoreIcon"
							alt="App Store"
							class="vendors-hero__app-icon"
						/>
						<img
							:src="playStoreIcon"
							alt="Google Play"
							class="vendors-hero__play-icon"
						/>
					</span>
				</div>
			</div>
			...
			<div class="vendors-hero__image-wrapper">
				<img
					:src="vendorImage"
					alt="Happy vendor with shopping bags"
					class="vendors-hero__image"
				/>
			</div>
