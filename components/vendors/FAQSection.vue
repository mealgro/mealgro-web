...
const questions = [
  'Does MealGro support small scale vendors?',
...
const answers = [
  'MealGro is a platform where all food vendors are accepted, Small, medium and Large scale businesses. MealGro helps make day to day sales easier and faster.',
