...
const questions = [
  ...
  'Do they have local meals too?',
  'Is it available on IOS?'
];

const answers = [
  'MealGro is a nationwide Food delivery app. This product connects food vendors with their ideal customers from wherever they are. This ensures convenience and effective self service.',
  'MealGro is currently available in multiple locations across the country. We are continuously expanding our coverage to serve more areas.',
  'Yes, MealGro offers a wide variety of local meals from restaurants and vendors in your area. You can discover and order from local favorites.',
  'Yes, MealGro is available on iOS. You can download it from the App Store and start ordering your favorite meals today.'
];
